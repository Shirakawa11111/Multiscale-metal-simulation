...
- **`experiment_bridge/`** — STEM-to-DDD v2: `stem_to_idr.py` (reconstruction → IDR, top-k slip-system
  ...
  `STEM_TO_DDD_V2_AUDIT.md` (index: `AUDIT_PACKAGE_INDEX.md`; one-click reproduce via
  `run_local_audit_package.py`, main figure `make_audit_figure.py`). Legacy direct converter
  `stem_to_exadis.py` kept as baseline. Transparency:
